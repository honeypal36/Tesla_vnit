    ...
    >
      ...
      <div className="flex justify-center gap-6 py-8">
        <a
          ...
          className="rounded-full border-2 border-white w-12 h-12 flex items-center justify-center text-xl hover:bg-white hover:text-black transition-colors duration-200"
        >
          <svg
